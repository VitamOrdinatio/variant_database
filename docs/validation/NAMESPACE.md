...
> Core question:
> How do we prove VDB behavior is correct and reproducible?
...
2. What validation checks are required?
3. What evidence demonstrates correctness?
4. What failure modes must be detected?
